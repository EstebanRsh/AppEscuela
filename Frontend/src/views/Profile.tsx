  ...
  const handlePasswordChange = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch(
        "http://localhost:8000/user/change-password/self",
        {
          method: "POST",
          headers: {
      ...
      <div className="container mt-4">
        ...
        >
          <div className="card-header">
            <h1 className="m-0 h3">
              <i className="bi bi-person-badge-fill text-warning me-2"></i>Mi
              Perfil
            </h1>
          </div>
                ...
                <div className="security-section">
                  {!isEditingPassword ? (
                    ...
                    <form onSubmit={handlePasswordChange}>
                      ...
                      <div className="mb-3">
                        <label htmlFor="confirm_new_password">Confirmar</label>
                        <input
                          type="password"
